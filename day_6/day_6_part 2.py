...
day_6_file = "/Users/dyl13740/AdventofCode2024/AOC-2024/day_6/day_6_input_2.txt"
...
# Count the number of 'X' in lab_layout
count = np.count_nonzero(lab_layout == "X")

# print(lab_layout)
print(f"Final Guard location: {guard_info[0]} | {guard_info[1]}")
print(f"Number of 'X' in lab_layout: {count}")
