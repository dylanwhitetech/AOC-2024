...
with open("/Users/dyl13740/AdventofCode2024/AOC-2024/day_6/day_6_input_2.txt") as file:
    for line in file:
...
def check_loop(_grid: list[list[str]], _dy: int, _dx: int, _guard_pos_y: int, _guard_pos_x: int, _dir_index: int) -> None:
    _grid_visited: dict[tuple[int, int], list[int]] = {}
    while True:
